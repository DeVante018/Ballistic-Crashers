...
class Sputter(x: Double, y: Double,movement:String) extends Enemies {
  override val name: String = "sputter" //enemy name type
  ...
  override var laserUpdateAlpha: Double = 1.45 // interval between lasers shooting
  override var laserSpeed: Double = 87.34 // speed at which the lasers travel
